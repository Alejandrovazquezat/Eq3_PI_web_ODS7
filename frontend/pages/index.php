...
<head>
    <meta charset="UTF-8">
    <title>Inicio - Redrenovable</title>
...
<body style="background-color: #f1f5f9;">
    ...
    <main class="main-content">
        ...
        <!-- Hero -->
        <div style="background: linear-gradient(135deg, #1e3a8a, #3b82f6); color: white; padding: 80px 5%; text-align: center; border-radius: 0 0 40px 40px; margin-bottom: 30px;">
